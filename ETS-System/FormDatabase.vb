Public Class FormDatabase
    Private Sub FormDatabase_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'JCLODataSet.Ticket' table. You can move, or remove it, as needed.
        Me.TicketTableAdapter.Fill(Me.JCLODataSet.Ticket)
